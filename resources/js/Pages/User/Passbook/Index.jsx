...
export default function Index({ passbookOwner, savingGoals = [], transactions, summary, filters }) {
    ...
    const applyFilter = (e) => {
        ...
        router.get('/passbook', filterData, {
            preserveState: true,
            preserveScroll: true,
        });
    };

    const pdfUrl = () => `/passbook/pdf?${new URLSearchParams(filterData).toString()}`;

    return (
        <UserLayout>
            <Head title="Buku Tabungan" />
            ...
            <div className="mx-auto max-w-7xl space-y-6">
                <div className="no-print">
                    ...
                    <p className="mt-2 text-sm text-[#5D5B54]">
                        Cetak atau download laporan transaksi approved milik Anda.
                    </p>
                </div>
